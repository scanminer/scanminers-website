        ...
        <div className="space-y-10">
          ...
          <section className="space-y-6 rounded-3xl border border-secondary/20 bg-gradient-to-br from-secondary/5 via-background to-background p-6 shadow-xl sm:p-10">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-fg">
                60-Minute <span className="bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent">Critical Minerals</span> Prospectivity Consultation
              </h1>
              <p className="text-lg leading-relaxed text-fg/80">
                ...
                and exploration objectives. Built for leaders who want <strong className="text-fg">concrete guidance</strong>—not a generic sales pitch.
              </p>
              <ul className="space-y-2.5 text-base text-fg/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>Review your regions, commodities, and available data (remote sensing, geophysics, geochemistry, drilling).</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-secondary"></span>
                  <span>Identify where Scanminers&apos; prospectivity and geohazard workflows add the most value.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-secondary"></span>
                  <span>Receive a concise follow-up note summarising next steps and potential engagement paths.</span>
                </li>
              </ul>
              <div className="flex flex-wrap gap-3 pt-2">
                <a href="#consultation-form" className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-secondary to-accent px-6 py-3.5 text-base font-bold text-white shadow-lg transition-all hover:shadow-xl hover:scale-[1.02]">
                  Request a paid consultation
                </a>
                <Link href="/prospectivity-brief" className="inline-flex items-center text-sm font-bold text-primary hover:underline">
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-2">
              <div className="space-y-4 rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 to-background p-5">
                ...
                <ul className="space-y-2.5 text-sm text-fg/70">
                  <li className="flex items-start gap-2">
                    ...
                    <span>VPs / Heads of Exploration planning critical mineral programmes</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
                    <span>Technical leads and chief geologists evaluating AI-assisted prospectivity workflows</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
                    <span>Government agencies and surveys designing regional screening or tender areas</span>
                  </li>
                </ul>
              </div>
              <div className="space-y-4 rounded-2xl border border-secondary/20 bg-gradient-to-br from-secondary/5 to-background p-5">
                ...
                <ul className="space-y-2.5 text-sm text-fg/70">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-secondary"></span>
                    <span>Students or general-interest calls (use the Insights library instead)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-secondary"></span>
                    <span>Organisations without defined AOIs, commodities, or timelines</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="rounded-3xl border border-accent/20 bg-gradient-to-br from-accent/5 via-background to-background p-6 shadow-lg sm:p-10">
            ...
            <div className="mt-6 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="mb-2 text-base font-bold text-fg">Scoping & Discovery</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="mb-2 text-base font-bold text-fg">Prototype Exploration View (if appropriate)</h3>
                  <p className="text-sm leading-relaxed text-fg/70">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="mb-2 text-base font-bold text-fg">Scoped Engagement Definition</h3>
                  <p className="text-sm leading-relaxed text-fg/70">
            ...
            <div className="mt-6 rounded-xl border border-success/30 bg-gradient-to-br from-success/10 to-success/5 p-5 shadow-sm">
              <p className="text-sm leading-relaxed text-fg/80">
                <strong className="font-bold text-fg">Outcome:</strong> You leave with concrete next steps—not a generic sales pitch. If a full project makes sense, we&apos;ll outline deliverables, timelines, and pricing. If not, we&apos;ll tell you honestly.
              </p>
            </div>
          </section>
          ...
          <section className="rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/5 via-background to-background p-6 shadow-lg sm:p-10">
            ...
            <ul className="mt-6 space-y-3 text-sm text-fg/70">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
                <span><strong className="font-bold text-fg">Duration:</strong> 60 minutes (online)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
                <span><strong className="font-bold text-fg">Format:</strong> Zoom/Teams with live review of maps, datasets, and workflows</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
                <span><strong className="font-bold text-fg">Deliverables:</strong> Discussion + concise written follow-up with recommended actions</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
                <span><strong className="font-bold text-fg">Investment:</strong> €X00 (excl. VAT)</span>
              </li>
            </ul>
          ...
          <section className="rounded-3xl border border-secondary/20 bg-gradient-to-br from-secondary/5 via-background to-background p-6 shadow-lg sm:p-10">
            ...
            <ol className="mt-6 space-y-4">
              <li className="flex items-start gap-4">
                ...
                <p className="pt-1 text-sm leading-relaxed text-fg/70">Submit the request form so we can confirm fit.</p>
              </li>
              <li className="flex items-start gap-4">
                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-secondary to-secondary/70 text-sm font-bold text-white shadow-md">
                  2
                </div>
                <p className="pt-1 text-sm leading-relaxed text-fg/70">We send a payment reference and bank transfer details (IBAN, SWIFT/BIC, account name).</p>
              </li>
              <li className="flex items-start gap-4">
                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-secondary to-secondary/70 text-sm font-bold text-white shadow-md">
                  3
                </div>
                <p className="pt-1 text-sm leading-relaxed text-fg/70">Share proof of payment or remittance advice.</p>
              </li>
              <li className="flex items-start gap-4">
                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-secondary to-secondary/70 text-sm font-bold text-white shadow-md">
                  4
                </div>
                <p className="pt-1 text-sm leading-relaxed text-fg/70">We propose times and send a calendar invite with call details.</p>
              </li>
            </ol>
